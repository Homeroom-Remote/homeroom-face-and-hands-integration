    ...
    function (t, e, n) {
      ...
      var b = (function () {
        function t(e) {
          ...
          v(this, t), (this.estimator = new p(n)), (this.gestures = e);
        }
        var e, n, r;
        return (
          (e = t),
              ...
              value: function (t, e) {
                ...
                try {
                  for (d.s(); !(s = d.n()).done; ) {
                    ...
                    p >= e && r.push({ name: h.name, score: p });
                  }
                } catch (t) {
                  d.e(t);
                } finally {
      ...
      var S = (function () {
        ...
        C = new S("victory");
      C.addDirection(a.Thumb, l.VerticalUp, 1),
        C.addDirection(a.Thumb, l.DiagonalUpLeft, 1),
        C.addDirection(a.Thumb, l.DiagonalUpRight, 1),
        C.addCurl(a.Index, o.NoCurl, 1),
        C.addDirection(a.Index, l.VerticalUp, 1),
        C.addDirection(a.Index, l.DiagonalUpLeft, 1),
        C.addDirection(a.Index, l.DiagonalUpRight, 1),
        C.addDirection(a.Index, l.HorizontalLeft, 1),
        C.addDirection(a.Index, l.HorizontalRight, 1),
        C.addCurl(a.Middle, o.NoCurl, 1),
        C.addDirection(a.Middle, l.VerticalUp, 1),
        C.addDirection(a.Middle, l.DiagonalUpLeft, 1),
        C.addDirection(a.Middle, l.DiagonalUpRight, 1),
        C.addDirection(a.Middle, l.HorizontalLeft, 1),
        C.addDirection(a.Middle, l.HorizontalRight, 1),
        C.addCurl(a.Ring, o.FullCurl, 1),
        C.addCurl(a.Ring, o.HalfCurl, 0.9),
        C.addCurl(a.Pinky, o.FullCurl, 1),
        C.addCurl(a.Pinky, o.HalfCurl, 0.9);
      var A = C,
        R = new S("thumbs_up");
      R.addCurl(a.Thumb, o.NoCurl, 1),
        R.addDirection(a.Thumb, l.VerticalUp, 1),
        R.addDirection(a.Thumb, l.DiagonalUpLeft, 0.9),
        R.addDirection(a.Thumb, l.DiagonalUpRight, 0.9);
      for (
        var I = 0, L = [a.Index, a.Middle, a.Ring, a.Pinky];
        I < L.length;
        I++
      ) {
        var _ = L[I];
      ...
      R.addDirection(a.Index, l.DiagonalUpLeft, 1),
        R.addDirection(a.Index, l.HorizontalLeft, 1),
        R.addDirection(a.Index, l.HorizontalRight, 1),
        R.addDirection(a.Index, l.DiagonalUpRight, 1);
      var E = R;
      e.default = {
        GestureEstimator: b,
